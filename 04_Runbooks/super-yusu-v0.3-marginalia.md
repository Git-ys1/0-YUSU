...
- Ingest state on 2026-06-05: 98 file entries in DB, all `ingest_status=done`, all with summaries.
- Semantic index state on 2026-06-05: `semantic-index/default` built with 98 entries, `BAAI/bge-m3`, 1024 dimensions.
- Local UI/API state on 2026-06-05: API `http://127.0.0.1:8000`, UI `http://127.0.0.1:5173`, embedding shim `http://127.0.0.1:8011/v1`.
