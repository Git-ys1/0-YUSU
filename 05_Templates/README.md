...
轻量项目可以只填基础文件。成熟项目必须继续补齐 `07_development_history.md`、`08_onboarding_from_zero.md`、`09_session_evidence.md` 和 `adr/`，并按 `04_Runbooks/mature-project-ingestion.md` 做多轮证据挖掘。
