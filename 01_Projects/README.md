...
| 企业微信 DeepSeek Bot | `wecom-deepseek-bot` | `F:\Project\微信智能体\wecom-deepseek-bot` | 企业微信智能机器人长连接后端；Node.js + TypeScript + DeepSeek/Mock Provider |
...
| 2026 电赛 G 题周期信号测量分析装置 | `stm32g474-tjc-display` | `F:\Project\stm32G474VETx\TI`; final code `G_Periodic_Signal_Analyzer\teammate\24` | 比赛已结束，获北京市二等奖；显示与双ADC融合工程 |
...
| CleanScout Rover OrangePi AI | `cleanscout-rover-orangepi-ai` | `F:\Project\CleanScout_rover\OrangePi`; board path `~/rk3588_ai` | RK3588 NPU、YOLO11、RealSense 与机械臂视觉链路 |
| 27 考研 - 北交电气学硕 | `kaoyan-bjtu-ee` | `F:\AcademicHub\000资料相关\000考研` | Long-term exam-prep workspace for 北京交通大学 080800 电气工程学硕 |
| Video to Codex Spec | `video-to-codex-spec` | `F:\AcademicHub\video-analysis-with-aoai` | 视频场景、关键帧、OCR、ASR 与 `agent_context/` 规格提取工具 |
| YUSU Personal Site | `yusu-personal-site` | `F:\AcademicHub\0#YUSU\07_PersonalSite` | 本地个人展示墙、例程日历、Marginalia 和 YUSU 知识库检索入口；V0.8 local runtime |
