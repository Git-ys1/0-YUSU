...
The YUSU repository started as a shared Codex knowledge vault. V0.3 needs a human-facing layer so the user can browse what exists, inspect proof materials, and search the old knowledge base without memorizing folder paths.
