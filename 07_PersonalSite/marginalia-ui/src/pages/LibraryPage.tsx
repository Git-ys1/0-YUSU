      ...
      >
        {selectedEntry && (
          <button
            ...
            className="absolute left-2 top-2 z-20 flex h-8 items-center gap-1 rounded-md border border-border bg-bg-elevated px-2 text-xs shadow-sm sm:hidden"
          >
            <ArrowLeft size={14} /> {t.nav.library}
          </button>
        )}
        {selectedEntry ? (
          <FileViewer
