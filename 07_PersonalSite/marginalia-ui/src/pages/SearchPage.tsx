...
export function SearchPage() {
  ...
  return (
    <div className="h-full overflow-hidden p-2 pb-20 md:p-4 md:pb-4">
      <div className="flex h-full flex-col overflow-hidden rounded-lg border border-border bg-bg-elevated/70 shadow-[0_18px_60px_rgb(0_0_0_/_0.20)]">
      <div className="border-b border-border bg-bg-subtle/95 px-4 py-4 sm:px-6">
