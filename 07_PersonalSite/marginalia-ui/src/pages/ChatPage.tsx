        ...
        <div className="border-t border-border bg-bg-subtle px-3 py-3 sm:px-6">
          <div className="mx-auto flex max-w-5xl flex-wrap items-end gap-2 sm:flex-nowrap">
            ...
            <textarea
              ...
              rows={1}
              className={cn(
                "order-1 w-full flex-none resize-none rounded-md border border-border bg-bg-base px-3 py-2 text-sm sm:order-2 sm:w-auto sm:flex-1",
            ...
            {streaming ? (
              <button
                onClick={stop}
                className="order-3 flex h-9 items-center gap-1 rounded-md border border-border bg-bg-elevated px-3 text-sm hover:bg-bg-muted"
              >
              ...
              <button
                ...
                disabled={!input.trim()}
                className={cn(
                  "order-3 flex h-9 items-center gap-1.5 rounded-md px-3 text-sm font-medium transition-colors",
                  input.trim()
