/** Settings page for the integrated same-origin YUSU runtime.
 *
 *  1. Preferences: theme, default conflict policy, status-bar polling
 *  2. Retrieval: embedding recall and rerank runtime overlay
