/** Typed fetch wrapper for the integrated /v1/ API.
 *
 *  The YUSU build serves this React app and Marginalia's FastAPI routes from
 *  the same origin. VITE_API_BASE remains available for isolated build-time
 *  tests, but normal runtime requests are always relative to port 8787.
 *
